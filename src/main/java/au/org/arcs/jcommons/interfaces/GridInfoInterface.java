...
public interface GridInfoInterface {
    ...
    // having Gateway in the name makes it too specific to the Gateway method and
    ...
    public abstract String[] getGridFTPServersForQueueAtSite(String site, String queue);
    
    public abstract String[] getStorageElementsForSite(String site);
    
    public abstract String[] getGridFTPServersForStorageElementAtSite(String site, String storageElement);
    
    public abstract String getDefaultStorageElementForQueueAtSite(String site, String queue);
    
    public abstract String[] getDataDir(String site, String storageElement, String FQAN);
    ...
    public abstract String[] getVersionsOfCodeForQueueAndContactString(String queueName, String contactString, String code);

    public abstract String[] getClustersForCodeAtSite(String site, String code, String version);
    
    public abstract String[] getQueueNamesForCodeAtSite(String site, String code);
    
    public abstract String[] getQueueNamesForCodeAtSite(String site, String code, String version);
     ...
     */
    public abstract String[] getSitesWithAVersionOfACode(String code, String version);
    
    public abstract String[] getSitesWithCode(String code);
    
    
    
    // GERSON: An issue with the three methods below is that they both assume that
     ...
     */
    public abstract String[] getContactStringOfQueueAtSite(String site, String queue);
    
    // GERSON: has been renamed from getComputeElementsOfClusterAtSite to be 
    // consistent with calling ComputingElements as Queues
    
    /**
     * Get the queue names of the cluster at site
     * site.
     * 
     * @param site The site to check
     * @return An array of compute elements
     */
    public abstract String[] getQueueNamesForClusterAtSite(String site, String cluster);    
