...
public enum DefaultDependencies {
	...
	ARCSGSI("au.org.arcs.auth.slcs.ArcsGsiPackageIndicator", "http://code.arcs.org.au/nexus/content/repositories/snapshots/au/org/arcs/auth/arcs-gsi/${version}/arcs-gsi-${version}-lib.jar"),
