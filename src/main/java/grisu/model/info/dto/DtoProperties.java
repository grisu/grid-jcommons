...
public class DtoProperties implements Comparable<DtoProperties> {
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof DtoProperties)) {
            return false;
        }
        DtoProperties o = (DtoProperties) other;

        if (this.size() != o.size()) {
            return false;
        }
        for (DtoProperty p : getProperties()) {
            Object other_value = o.get(p.getKey());
            Object this_value = p.getValue();

            boolean e = Objects.equal(this_value, other_value);
            if (!e) {
                return false;
            }
        }
    ...
    @Override
    public int compareTo(DtoProperties o) {
        int i = size()-o.size();
        if ( i != 0 ) {
            return i;
        }
        for (DtoProperty p : getProperties()) {
            ...
            // this doesn't check for when other does not have that particular value
            ...
            i = this_value.hashCode()-other_value.hashCode();
            if ( i != 0 ) {
                return i;
            }
        }
